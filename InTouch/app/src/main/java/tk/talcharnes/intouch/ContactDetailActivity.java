...
public class ContactDetailActivity extends AppCompatActivity {
    ...
    private String createStringFromArrayList(String[] arrayList){
    ...
    private ArrayList<String> getArrayListFromJSONString(String stringreadfromsqlite) throws JSONException {
